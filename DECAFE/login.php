...
<body class="text-center">
    ...
    <main class="form-signin w-100 m-auto">
        ...
        <img class="mb-4" src="ab.jpg" alt="" width="72" height="57">
            ...
            <div class="checkbox mb-3">
                <label>
                    <input type="checkbox" value="remember-me"> Halo
                </label>
            </div>
            <button class="w-100 btn btn-lg btn-primary" type="submit" name="submit_validate" value="abc">Login</button>
            <p class="mt-5 mb-3 text-muted">&copy; naomi natalie br sembiring</p>
        </form>
    </main>
